                  ...
                  isCart.map((item, index) => (
                    <tbody key={index}>
                      <tr>
                        ...
                        <td>
                          <DeleteOutlined onClick={() => showDeleteConfirm(item.id)} />
                          <EditOutlined
                    ...
                    <div>
                      <button
                        style={{
                          ...
                          backgroundColor: selectedColor === cl?.id ? 'rgb(159,134,217)' : 'white'
                        }}
                  ...
                  <div>
                    <button
                      style={{
                        ...
                        backgroundColor: selectedSize === sz?.id ? 'rgb(159,134,217)' : 'white'
                      }}
            ...
            <div className='row' style={{ display: 'flex', justifyContent: 'end' }}>
                  ...
                  <div className='box-cart-total'>
                    ...
                    <div className='item-total border-0'>
                      ...
                      <span className='font-xl-bold'>
                        <span>
                          {(
                            isCart.reduce((acc, item) => acc + Number(item.price) * Number(item.quantity), 0) *
                            (1 - discountValue / 100)
                    ...
                    <Link to={`/checkout/${userId}`}>
                      <button className='btn btn-brand-1-xl-bold w-100 font-sm-bold'>Tiến hành thanh toán</button>
                    </Link>
                  </div>
                </div>
              )}
              <div className='col-lg-3 mb-30'>
                <div className='box-button-checkout'>
                  <Link to='/product' className='btn btn-brand-1-border-2 mr-10'>
                    Tiếp tục mua sắm
                    <svg
