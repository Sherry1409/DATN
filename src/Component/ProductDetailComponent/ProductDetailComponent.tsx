    ...
    const GetProductsById = async () => {
      try {
        if (product?.categories?.id) {
          const { data } = await api.get(`/categories/${product.categories.id}/products`)
          ...
          <div className='container'>
                ...
                <div className='box-product-info'>
                  ...
                  {product.reviews.length > 0 && (
                    <div className='block-rating'>
                      <Rate style={{ fontSize: '14px' }} disabled defaultValue={product.average_rating} />
                    </div>
                  )}
                  {/* end */}
                  <span style={{ fontFamily: 'Raleway' }} className='font-md neutral-500'>
                    ({product.reviews.length} Reviews - {product.sell_quantity} Orders)
                  </span>
                  ...
                  <div className='block-view'>
                    <p style={{ fontFamily: 'Raleway' }} className='font-md neutral-900'>
                      {product.description}
                    </p>
                  </div>
                  ...
                  <div className='block-color'>
                    ...
                    <label style={{ fontFamily: 'Raleway', marginLeft: '5px' }}>{selectedColor || 'Chọn Màu'}</label>
                      ...
                      {product.colors.map((color: any) => (
                        <button
                          ...
                          style={{
                            ...
                            padding: '10px 15px',
                            border:
                              selectedColor === color.name_color ? '1px solid rgb(159,137,219)' : '1px solid gray',
                            borderRadius: '8px',
                  ...
                  <div className='block-size'>
                    ...
                    <label style={{ fontFamily: 'Raleway', marginLeft: '5px' }}>{selectedSize || 'Chọn Size'}</label>
            ...
            <div className='box-detail-product'>
              ...
              <div className='tab-content'>
                ...
                >
                  <span style={{ fontFamily: 'Raleway', fontSize: '15px' }}>{product.description}</span>
                </div>
                {/* Đánh giá */}
                    ...
                    {product.reviews.map((review: any, index: any) => (
                      <>
                        <section className='layout-rating' key={index}>
                          <div>
                            <img className='img-rating' src={`${review.user_avatar}`} alt='' />
                          </div>
                          <div className='text-rating'>
                            <span className='name-user'>{review.user_name}</span>
                            {/* {dayjs(review.created_at).format('DD/MM/YYYY HH:mm:ss')} */}
                            <div className='star-ratings'>
                              <Rate disabled defaultValue={review.rating} />
                            </div>
                            <p style={{ fontSize: '14px' }} className='content-rating'>
                              {review.comment}
                            </p>
                          </div>
                        </section>
                        ...
                        <div className='cardProduct wow fadeInUp' key={index}>
                          <div className='cardImage'>
                            ...
                            <a href='product-single.html'>
                              <img className='imageMain' src={product.avatar_url} alt='kidify' />
                              <img className='imageHover' src={product.avatar_url} alt='kidify' />
                            </a>
