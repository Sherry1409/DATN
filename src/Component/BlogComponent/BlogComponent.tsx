...
const BlogComponent: React.FC = () => {
  ...
  const paginatedBlog = blog.slice((current - 1) * pageSize, current * pageSize)
              ...
              <div className='col-1'>
                <div className='box-inner-blog-padding'>
                        ...
                        <div className='cardInfo'>
                          ...
                          <div className='mt-25 text-end'>
                            <a className='btn btn-arrow-right' href='#'>
                              ...
                              <img className='hover-icon' src={Arrow} alt='Kidify' />
                            </a>
                          </div>
                        </div>
                      </div>
                  ...
                  <nav className='box-pagination' style={{ float: 'right' }}>
                    <Pagination current={current} onChange={onChange} total={blog.length} pageSize={pageSize} />
                  </nav>
                </div>
              </div>
              {/* Aside Blog */}
                  ...
                  <div className='row' data-masonry='{"percentPosition": true }'>
                    <div className='col-lg-12 col-md-6'>
                      <div className='sidebar-border'>
                        <h5 className='font-3xl-bold head-sidebar'>Bài viết mới nhất</h5>
                              ...
                              <li key={index}>
                                <Link to={`/blog-detail/${b.id}`}>
                                  <div className='cardFeaturePost'>
                                    ...
                                    <div className='cardInfo'>
                                      <span className='lbl-tag-brand'>{truncateText(b.title)}</span>
                                      <a className='font-sm-bold link-feature' href='#'>
