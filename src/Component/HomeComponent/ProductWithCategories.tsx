...
const ProductWithCategories: React.FC = () => {
  ...
  const paginatedProducts = products.slice((current - 1) * pageSize, current * pageSize)
  ...
  const paginatedNewProducts = Newproducts.slice((current - 1) * pageSize, current * pageSize)
  ...
  const paginatedTopProducts = Topproducts.slice((current - 1) * pageSize, current * pageSize)
      ...
      <section className='section block-section-1'>
        <div className='container'>
          ...
          <div className='tab-content'>
            <div className='tab-pane fade show active' id='girls' role='tabpanel' aria-labelledby='girls-tab'>
              <div className='row'>
            ...
            <div className='tab-pane fade' id='boys' role='tabpanel' aria-labelledby='boys-tab'>
              <div className='row'>
            ...
            <div className='tab-pane fade' id='accessories' role='tabpanel' aria-labelledby='children'>
              <div className='row'>
          ...
          <nav className='box-pagination' style={{ float: 'right' }}>
            <Pagination current={current} onChange={onChange} total={products.length} pageSize={pageSize} />
          </nav>
        </div>
      </section>
    </>
