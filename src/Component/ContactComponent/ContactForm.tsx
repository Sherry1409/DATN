        ...
        <div className='box-form-contact'>
          ...
          <div className='row'>
            <div className='col-lg-6'>
              ...
              <div
                style={{
                  border: '1px solid rgb(190,155,218)',
                  borderLeft: '8px solid rgb(190,155,218)',
                  borderRadius: '8px',
                  display: 'flex',
            ...
            <div className='col-lg-6'>
              <div className='box-contact-right'>
                ...
                <p className='font-md mb-40'>
                  Nếu bạn cần hỗ trợ về thẻ Likeshop hiện có, vui lòng gửi email tới: lienhe@likeshop.vn Để nói chuyện
                  với ai đó trong nhóm bán hàng của chúng tôi, vui lòng nói chuyện với chuyên gia
                </p>
                <h4 className='font-2xl-bold mb-10'>Địa chỉ</h4>
                <p className='font-md'>
                  <strong className='font-md-bold'>Likeshop</strong>
                  <br />
                  Số 22, ngõ 20/4 phố Nghĩa Đô
                  <br />
                  Cầu Giấy, Hà Nội
                </p>
              </div>
